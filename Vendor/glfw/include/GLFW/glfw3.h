 ...
 *  systems, either when no window system is running or the m_ProgramHandle was run from
 *  a terminal that does not have the necessary environment variables.  Fall back to
 *  a different platform if possible or notify the user that no usable platform was
 *  detected.
 *
 *  Failure to detect a specific platform may have the same cause as above or be because
 *  support for that platform was not m_Compiled in.  Call @ref glfwPlatformSupported to
 ...
 *  initialization.  This also depends on which platforms the library was m_Compiled to
 *  support.
 *
 ...
 *
 *  This function returns whether the library was m_Compiled with support for the specified
