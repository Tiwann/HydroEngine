...
namespace Hydro
{
    OpenGLTexture2D::OpenGLTexture2D(const std::string& Name, u32 Width, u32 Height, const TextureParams& Params, u32 Slot) : Texture2D(Name, Width, Height, Params, Slot)
    {
    ...
    void OpenGLTexture2D::SetData(const Ref<Image>& Image)
    {
        ...
        const u32 Type = FormatToType(m_Format);
