...
namespace Hydro
{
    ...
    void VulkanRenderer::DrawRect(const Rectangle& Rect, const Color& Color)
    {
        RectShader->Compile();
    }

    void VulkanRenderer::DrawCircle(const Rectangle& Rect, float Radius, const Color& Color)
    {
    }

    vk::Device VulkanRenderer::GetDevice() const
    {
        return m_Device;
    }
    ...
    bool VulkanRenderer::CreateWindowSurface()
    {
    ...
    bool VulkanRenderer::CreateSwapchain()
    {
        ...
        for (size_t i = 0; i < SwapchainImageCount; i++) {
            ...
            ImageViewsCreateInfo.setComponents(vk::ComponentMapping());
    ...
    std::string VulkanRenderer::GetGPUTypeString(const vk::PhysicalDeviceType& DeviceType) const
    {
        switch (DeviceType)
        {
