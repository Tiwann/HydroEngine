#include "HydroPCH.h"
#include "DirectXRendererBackend.h"
...
namespace Hydro
{
    DirectXRendererBackend::DirectXRendererBackend() : RendererBackend()
    {
        HRESULT result;
        ...
        HYDRO_LOG(DirectX, Info, "Created command queue!");
        ...
        HYDRO_LOG(DirectX, Info, "Created command allocator!");
        ...
        HYDRO_LOG(DirectX, Info, "Created fence!");
    ...
    DirectXRendererBackend::~DirectXRendererBackend()
    {
    ...
    void DirectXRendererBackend::ClearDepthBuffer()
    {
            
    }

    void DirectXRendererBackend::ClearColor(const Color& color)
    {
        
    }

    void DirectXRendererBackend::SwapBuffers()
    {
